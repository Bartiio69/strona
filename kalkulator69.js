...
buttons.forEach(button => {
    button.addEventListener("click", function() {
        if (button.id === "c") {
            ...
            ekran.innerText = "Wszstkiego najlepszego!!1!!111!!!!111!11!";
            currentValue = "";
            firstValue = null;
            operator = null;
            operatorClicked = false;
            ...
            window.open("https://www.youtube.com/watch?v=_H8Vu-hEkok", "_blank"); // Rickroll w nowej karcie
        } else if (button.id === "<") {
            ...
            alert("Popatrz na stronie za przyciskami po kliknięciu ''='' ");
        } else {
